...
import com.velox.adfsApi.authentication.CustomSAMLAuthenticationProvider;
import com.velox.adfsApi.authentication.DefaultSAMLBootstrap;
...
//		String idpAzureMetadataURL = idpMetaDataUrl;
...
//      return extendedMetadataDelegate;
		...
		try {
			resource = new ClasspathResource(metadataResource);
		...
		ExtendedMetadataDelegate extendedDelegate = new ExtendedMetadataDelegate(provider, extendedMetadata());
